...
node {
  ...
  try {
    ...
    stage('Scan Packages') {
      snykSecurity additionalArguments: '--debug' severity: 'medium', snykInstallation: 'snyk-security-scanner', snykTokenId: 'Snyk-Token', targetFile: './FFCDemoPaymentService.sln'
    }
    stage('Run tests') {
