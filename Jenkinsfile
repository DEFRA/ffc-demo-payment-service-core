...
node {
  ...
  try {
    ...
    stage('Scan Packages') {
      snykSecurity projectName: 'ffc-demo-payment-service-core', severity: 'medium', snykInstallation: 'snyk-security-scanner', snykTokenId: 'Snyk-Token', targetFile: '${workspace}/FFCDemoPaymentService'
    }
    stage('Helm lint') {
